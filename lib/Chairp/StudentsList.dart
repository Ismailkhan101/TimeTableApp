...
class listofstudents extends StatefulWidget {
  ...
  listofstudents({required this.myData});
  @override
  State<listofstudents> createState() => _listofstudentsState(myData);
}

class _listofstudentsState extends State<listofstudents> {
 String mydata1="";
   _listofstudentsState(this.mydata1);
...
{
  print(_selectedDept);
final results = await conn.query('SELECT StudentId,CMSID,FirstName,LastName,Email,Phone,UserId,DepId FROM students WHERE DepId = $_selectedDept');
